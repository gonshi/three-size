!function a(b,c,d){function e(g,h){if(!c[g]){if(!b[g]){var i="function"==typeof require&&require;if(!h&&i)return i(g,!0);if(f)return f(g,!0);var j=new Error("Cannot find module '"+g+"'");throw j.code="MODULE_NOT_FOUND",j}var k=c[g]={exports:{}};b[g][0].call(k.exports,function(a){var c=b[g][1][a];return e(c?c:a)},k,k.exports,a,b,c,d)}return c[g].exports}for(var f="function"==typeof require&&require,g=0;g<d.length;g++)e(d[g]);return e}({1:[function(a,b,c){var d,e,f,g,h,i=function(a,b){function c(){this.constructor=a}for(var d in b)j.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},j={}.hasOwnProperty;d=a("../util/eventDispatcher"),f=a("../util/throttle"),h=null,e=function(a){function b(){b.__super__.constructor.call(this)}return i(b,a),b.prototype.exec=function(){var a;return a=new f(300),$(window).on("resize",function(b){return function(){return a.last(function(){return b.dispatch("RESIZED",b)})}}(this))},b.prototype.off=function(){return $(window).off("resize")},b}(d),g=function(){var a;return a||(a=new e),a},b.exports=g},{"../util/eventDispatcher":6,"../util/throttle":8}],2:[function(a,b,c){/*!
  * Main Function
 */
var d,e,f,g,h;window._DEBUG?null!=Object.freeze?window.DEBUG=Object.freeze(window._DEBUG):window.DEBUG={state:!0}:null!=Object.freeze?window.DEBUG=Object.freeze({state:!1}):window.DEBUG={state:!1},a("../js/velocity.min.js"),a("./model/preload"),h=a("./util/ticker")(),g=a("./util/social")(),e=a("./controller/resizeHandler")(),f=a("./model/sizeData")(),d=a("./model/imgData")(),$(function(){var a,b,c,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,A,B,C;return c=$(".boy"),i=$(".girl"),p=i.find(".value"),o=i.find(".parts.top"),j=i.find(".parts.middle"),b=i.find(".parts.bottom"),k=$(".notice_container"),m=$(".result_container"),l=m.find(".pic"),a=m.find(".again"),n=[m.find(".fb-share"),m.find(".tweet"),m.find(".line")],w=null,v=null,A=null,z={top:!1,middle:!1,bottom:!1},B={top:[85,80],middle:[65,60],bottom:[88,84]},C={top:{min:75,range:35},middle:{min:52,range:33},bottom:{min:80,range:30}},y=!0,x=0,s=[],r=900,q=500,t=function(){var a,b;return b=Math.random(),A=.1>b?"chara":.2>b?"man":"woman",a=Math.floor(Math.random()*window.size[A].length),v=window.size[A][a],window.size[A].splice(a,1),0===window.size[A].length?window.size[A]=s[A].concat():void 0},h.listen("checkLoad",function(){var a;if(null!=window.size.woman){for(a in window.size)s[a]=window.size[a].concat();return h.clear("checkLoad"),i.find(".guard").hide(),t(),h.listen("slot",function(a){return z.top||o.attr({"data-size":parseInt(a/100)%3+1}),z.middle||j.attr({"data-size":parseInt(a/80)%3+1}),z.bottom?void 0:b.attr({"data-size":parseInt(a/120)%3+1})})}}),k.find(".notice-yes").on("click",function(){return k.velocity({opacity:0},function(){return k.hide(),setTimeout(function(){var a;for(a in z)if(z[a])return;return $(".girl .advice").show().velocity({opacity:1,translateX:-30}),setTimeout(function(){return $(".girl .advice").hide()},8*q)},4*q)})}),i.find(".parts").on("click",function(){var b,e,f,g,h,j,k,l;if(g=$(this).data("type"),!z[g]){for(b=i.find(".value."+g),b.find(".length").text(v[g]),window.isSp&&m.find("."+g+" .length").text(v[g]),z[g]=!0,j=k=0,l=B[g].length;l>=0?l>k:k>l;j=l>=0?++k:--k){if(parseInt(v[g])>B[g][j]){$(this).attr({"data-size":j+1});break}j===B[g].length-1&&$(this).attr({"data-size":j+1})}return f=1+(v[g]-C[g].min)/C[g].range,f>2&&(f=2),h=window.isSp?-1:1,b.velocity({opacity:1,translateX:40*f*h,scale:f},q,"spring"),z.top&&z.middle&&z.bottom?(x+=1,window.ga("send","event","button","click","fin-"+x,1),setTimeout(function(){return c.addClass("think")},2*q),m.find(".name").text(v.name),d.getData(v.name),e=y?q:0,y=!1,setTimeout(function(){var b,d,e;for(h=window.isSp?0:1,"man"===A?c.removeClass("think").addClass("surprised").velocity({translateX:-80*h,scale:w},q,"spring"):c.removeClass("think").addClass("happy").velocity({translateX:-80*h,translateY:-20,scale:w},q/2),m.show().velocity({opacity:1,translateX:30},2*q),window.isSp&&p.velocity({opacity:0},q/2),b=window.isSp?30:0,j=d=0,e=n.length;e>=0?e>d:d>e;j=e>=0?++d:--d)n[j].delay(3.4*q+.2*j*q).velocity({opacity:1,scale:[1,.8]},q,"spring");return a.delay(4*q).velocity({opacity:1,scale:[1,.8],translateX:b},q,"spring")},5*q+Math.random()*q*3+e)):void 0}}),e.listen("RESIZED",function(){var a;return a=$(window).height(),w=window.isSp?.8:r>a?a/r:1,window.isSp||i.velocity({scale:w},30),c.velocity({scale:w},30)}),d.listen("IMG_LOADED",function(a){var b,c,d,e;for(e=[],b=c=0,d=a.length;d>=0?d>c:c>d;b=d>=0?++c:--c)e.push(l.eq(b).css({"background-image":"url("+a[b].image.thumbnailLink+")"}));return e}),a.on("click",function(){var b,d,e;for(c.removeClass().addClass("boy").velocity({translateX:0,translateY:0},50),t(),p.velocity({opacity:0,translateX:0,scale:1}),m.velocity({opacity:0,translateX:0},function(){return m.hide(),z={top:!1,middle:!1,bottom:!1}}),b=d=0,e=n.length;e>=0?e>d:d>e;b=e>=0?++d:--d)n[b].velocity({opacity:0},50);return a.velocity({opacity:0},50),l.css({"background-image":"none"})}),f.getData(),e.exec(),e.dispatch("RESIZED",e),g.exec("fb","tweet"),window.isAndroid&&(u=window.innerWidth/640,window.onload=function(){return document.body.style.zoom=u},m.find(".pic_container").css({height:$(window).height()/u*.85*.8*.81-71})),window.isSp&&$(".girl .advice").html($(".girl .advice").html().replace("クリック","タップ")),"#skip"===window.location.hash?$(".notice_container .notice-yes").trigger("click"):void 0})},{"../js/velocity.min.js":10,"./controller/resizeHandler":1,"./model/imgData":3,"./model/preload":4,"./model/sizeData":5,"./util/social":7,"./util/ticker":9}],3:[function(a,b,c){var d,e,f,g,h=function(a,b){function c(){this.constructor=a}for(var d in b)i.call(b,d)&&(a[d]=b[d]);return c.prototype=b.prototype,a.prototype=new c,a.__super__=b.prototype,a},i={}.hasOwnProperty;d=a("../util/eventDispatcher"),g=null,e=function(a){function b(){b.__super__.constructor.call(this),window.response=function(a){return function(b){return a.dispatch("IMG_LOADED",a,b.responseData.results)}}(this)}return h(b,a),b.prototype.getData=function(a){return $.ajax({type:"get",url:"https://www.googleapis.com/customsearch/v1?key=AIzaSyDnLFO5WKX6LPVO4yEDZGsAqGIPVos-Gow&cx=016489218282066124601:rfqomcxwe0w&q="+encodeURIComponent(a)+"&searchType=image&num=4"}).done(function(a){return function(b){return a.dispatch("IMG_LOADED",a,b.items)}}(this))},b}(d),f=function(){return g||(g=new e),g},b.exports=f},{"../util/eventDispatcher":6}],4:[function(a,b,c){var d;d=$("<img>").attr({src:"img/common/balloon.png"}),$(".result").css({"background-image":"url("+d.attr("src")+")"})},{}],5:[function(a,b,c){var d,e,f,g,h;e={top:/バスト: (.*?),/,middle:/ウエスト: (.*?),/,bottom:/ヒップ: (.*?),/},f=/性別: (.*?)$/,window.gdata={},window.gdata.io={},window.size={},window.gdata.io.handleScriptLoaded=function(a){var b,c,d,g,h,i,j,k;for(c=a.feed.entry.length,k=[],h=i=0,j=c;j>=0?j>i:i>j;h=j>=0?++i:--i)d=a.feed.entry[h].content.$t.match(f)[1],"object"!=typeof window.size[d]&&(window.size[d]=[]),b=window.size[d].length,window.size[d][b]={},window.size[d][b].name=a.feed.entry[h].title.$t,k.push(function(){var c;c=[];for(g in e)c.push(window.size[d][b][g]=a.feed.entry[h].content.$t.match(e[g])[1]);return c}());return k},h=null,d=function(){function a(){}return a.prototype.getData=function(){return this.src="https://spreadsheets.google.com/feeds/list/1yjXNRJ2xGtyTN6d97pjDH3SZhdwbnVBvQVT9ydu2qi0/od6/public/basic?alt=json-in-script",$("head").append($("<script>").attr({src:this.src}))},a}(),g=function(){return h||(h=new d),h},b.exports=g},{}],6:[function(a,b,c){var d,e=[].slice;d=function(){function a(){this.listeners={},this.dispatched={}}return a.prototype.listen=function(a,b){return null!=this.listeners[a]?this.listeners[a].push(b):this.listeners[a]=[b]},a.prototype.dispatch=function(){var a,b,c,d,f,g,h,i;if(b=arguments[0],g=arguments[1],a=3<=arguments.length?e.call(arguments,2):[],this.listeners[b]){for(h=this.listeners[b],i=[],c=0,d=h.length;d>c;c++)f=h[c],i.push(f.apply(g||this,a));return i}},a.prototype.first=function(){var a,b,c,d,f,g,h,i;if(b=arguments[0],g=arguments[1],a=3<=arguments.length?e.call(arguments,2):[],this.listeners[b]&&null==this.dispatched[b]){for(this.dispatched[b]=!0,h=this.listeners[b],i=[],c=0,d=h.length;d>c;c++)f=h[c],i.push(f.apply(g||this,a));return i}},a.prototype.clear=function(a){return this.listeners[a]=null},a}(),b.exports=d},{}],7:[function(a,b,c){var d,e,f;f=null,d=function(){function a(){}return a.prototype.exec=function(){var a,b,c,d,e,f,g,h,i,j;for(i={},b=e=0,g=arguments.length;g>=0?g>e:e>g;b=g>=0?++e:--e)i[arguments[b]]=!0;if(null!=i.fb){if(a=document.getElementsByTagName("script")[0],document.getElementById("facebook-jssdk"))return;d=document.createElement("script"),d.id="facebook-jssdk",d.src="//connect.facebook.net/ja_JP/sdk.js#xfbml=1&appId=1427692494204579&version=v2.0",a.parentNode.insertBefore(d,a)}return null!=i.tweet&&(window.twttr=function(){var b;return a=document.getElementsByTagName("script")[0],document.getElementById("twitter-wjs")?void 0:(d=document.createElement("script"),d.id="twitter-wjs",d.src="https://platform.twitter.com/widgets.js",a.parentNode.insertBefore(d,a),null!=window.twttr?window.twttr:b={_e:[],ready:function(a){return b._e.push(a)}})}()),null!=i.hatena&&(c=document.createElement("script"),c.type="text/javascript",c.src="https://b.st-hatena.com/js/bookmark_button.js",c.async="async",c.charset="utf-8",h=document.getElementsByTagName("script")[0],h.parentNode.insertBefore(c,h)),null!=i.pocket&&(document.getElementById("pocket-btn-js")||(c=document.createElement("script"),c.id="pocket-btn-js",c.type="text/javascript",c.src="https://widgets.getpocket.com/v1/j/btn.js?v=1",j=document.getElementById("pocket-btn-js"),document.body.appendChild(c))),null!=i.gplus&&(f=document.createElement("script"),f.type="text/javascript",f.async=!0,f.src="https://apis.google.com/js/plusone.js",h=document.getElementsByTagName("script")[0],h.parentNode.insertBefore(f,h)),$(document).on("click",".fb-share button",function(a){return window.FB.ui({method:"share",href:window.location.href})})},a.prototype.callback=function(){var a;return window.twttr.ready(function(b){return b.events.bind("tweet",function(){return a("tw")})}),window.onload=function(){return window.FB.Event.subscribe("edge.create",function(b){return b?a("fb"):void 0})},a=function(a){return console.log(a)}},a}(),e=function(){return f||(f=new d),f},b.exports=e},{}],8:[function(a,b,c){var d;d=function(){function a(a){this.is_first=!0,this.interval=a,this.prevTime=0,this.timer=null}var b;return null!=(null!=(b=window.performance)?b.now:void 0)?window.getNow=function(){return window.performance.now()}:window.getNow=function(){return Date.now()},a.prototype.exec=function(a){var b,c;return c=window.getNow(),b=c-this.prevTime,clearTimeout(this.timer),b>=this.interval?(this.prevTime=c,a()):this.timer=setTimeout(function(){return a()},this.interval)},a.prototype.first=function(a){return this.is_first?(this.is_first=!1,a()):(clearTimeout(this.firstTimer),this.firstTimer=setTimeout(function(a){return function(){return a.is_first=!0}}(this),this.interval))},a.prototype.last=function(a){return clearTimeout(this.lastTimer),this.lastTimer=setTimeout(function(){return a()},this.interval)},a.prototype.triggerend=function(){return this.is_first=!0},a}(),b.exports=d},{}],9:[function(a,b,c){var d,e,f;f=null,d=function(){function a(){var a;this.listeners={},this.start={},(a=function(b){return function(){var c;for(c in b.listeners)b.listeners[c](getNow()-b.start[c]);return window.requestAnimFrame(a)}}(this))()}var b;return null!=(null!=(b=window.performance)?b.now:void 0)?window.getNow=function(){return window.performance.now()}:window.getNow=function(){return Date.now()},null!=window.requestAnimationFrame?window.requestAnimFrame=window.requestAnimationFrame:null!=window.webkitRequestAnimationFrame?window.requestAnimFrame=window.webkitRequestAnimationFrame:null!=window.mozRequestAnimationFrame?window.requestAnimFrame=window.mozRequestAnimationFrame:window.requestAnimFrame=function(a){return window.setTimeout(a,1e3/60)},a.prototype.listen=function(a,b){return this.start[a]=window.getNow(),this.listeners[a]=b},a.prototype.clear=function(a){return null!=a?(delete this.listeners[a],delete this.start[a]):(this.listeners={},this.start={})},a}(),e=function(){return f||(f=new d),f},b.exports=e},{}],10:[function(a,b,c){/*! VelocityJS.org (1.2.2). (C) 2014 Julian Shapiro. MIT @license: en.wikipedia.org/wiki/MIT_License */
